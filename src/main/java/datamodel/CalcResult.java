...
public class CalcResult implements Serializable {
	...
	private Map<String,Integer> c1234Results;
	
	public CalcResult(final String currencyPair, final Map<String,Integer> basicResults, final Map<String,Integer> spreadResults, final Map<String,Integer> c1212Results, final Map<String,Integer> c1234Results) {

		this.currencyPair = currencyPair;
		this.basicResults = basicResults;
		this.spreadResults = spreadResults;
		this.c1212Results = c1212Results;
		this.c1234Results = c1234Results;
	}
	...
	public final Map<String,Integer> get1234Results() { return c1234Results; }
} 